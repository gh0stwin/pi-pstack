...
![She tastes a finished dish while robots cook from a recipe box, with pinned cards naming the how, tdd, and poteto-mode skills above the counter.](./images/recipes.jpg)
...
- **A vague finish condition.** "make it better" gives the autonomous run nothing to check. Give a command or artifact that can pass or fail.
