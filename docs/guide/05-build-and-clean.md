...
The [Opening a PR playbook](../../skills/poteto-mode/playbooks/opening-a-pr.md) runs [`/skill:deslop`](../../skills/deslop/SKILL.md) on the diff before each commit and applies [`/skill:unslop`](../../skills/unslop/SKILL.md) to the PR description and commit bodies. Both ship with pi-pstack.
...
The division of labor is worth keeping straight. `/skill:deslop` cleans slop out of the code, `/skill:unslop` cleans it out of prose, and `/skill:no-comments` hands the comments to a reviewer who didn't write them.
