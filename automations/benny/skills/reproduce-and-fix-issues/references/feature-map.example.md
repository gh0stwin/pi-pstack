...
Copy this file outside `.pi/automations/benny/`, for example to `.pi/benny/feature-map.md`, and set `verification.feature_map_path` to the copy. Pack refreshes must not overwrite it.
...
#### How the verification adapter drives it
