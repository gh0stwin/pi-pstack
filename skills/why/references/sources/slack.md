...
Slack evidence tools vary. Check which Slack tool is available and inspect its tool schema first. It may require authentication. If authentication fails, stop and report the gap.
