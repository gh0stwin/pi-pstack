...
- `Read` tool calls against any `SKILL.md` file (workspace `.pi/skills/`, user-level `~/.pi/agent/skills/`, or package-installed paths under `~/.pi/agent/git/` and `~/.pi/agent/npm/`)
