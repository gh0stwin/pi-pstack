...
Use this reference when the Babysit playbook (`../playbooks/babysit.md`) handles review-bot or review-automation comments. The goal is not to ignore the bot by default. The goal is to stop treating every comment as a required code change.
